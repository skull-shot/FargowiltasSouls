        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (WorldSavingSystem.MasochistModeReal && Main.rand.NextBool(1200))
            {
                switch (Main.rand.Next(9))
                {
                    ...
                    case 5: player.AddBuff(ModContent.BuffType<RottingBuff>(), Main.rand.Next(300)); break;
                    case 6: player.AddBuff(ModContent.BuffType<SqueakyToyBuff>(), Main.rand.Next(120)); break;
                    case 7: player.AddBuff(ModContent.BuffType<UnstableBuff>(), Main.rand.Next(90)); break;
                    case 8: player.AddBuff(ModContent.BuffType<BerserkedBuff>(), Main.rand.Next(180)); break;
                }
            }
