        ...
        public override void AI()
        {
            ...
            switch ((int)NPC.ai[0])
            {
                ...
                case 2: //pause and then initiate dash
                    ...
                    if (++NPC.ai[1] > (NPC.ai[2] == 0 && NPC.localAI[3] > 1 && WorldSavingSystem.EternityMode ? 240 : windup)) //delay on first entry here
                    {
                        NPC.netUpdate = true;
                        NPC.ai[0]++;
                        NPC.ai[1] = 0;
                    ...
                    if (++NPC.ai[3] > 5)
                    {
                        ...
                        if (FargoSoulsUtil.HostCheck)
                        {
                            ...
                            */
                            ...
                            Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center - vel1 * 1500, vel1, ModContent.ProjectileType<AbomDeathrayMark>(), FargoSoulsUtil.ScaledProjectileDamage(NPC.defDamage, 4f * 3 / 8), 0f, Main.myPlayer, timeLeft);
