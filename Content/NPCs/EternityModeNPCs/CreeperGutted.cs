...
namespace FargowiltasSouls.Content.NPCs.EternityModeNPCs
{
    public class CreeperGutted : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            Projectile.NewProjectile(NPC.GetSource_FromThis(), NPC.Center, Vector2.Zero, ModContent.ProjectileType<FargowiltasSouls.Content.Projectiles.Accessories.PureHeart.CreeperHitbox>(), NPC.damage, 6f, (int)NPC.ai[0], heart);
