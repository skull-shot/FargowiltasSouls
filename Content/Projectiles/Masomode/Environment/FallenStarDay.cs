...
namespace FargowiltasSouls.Content.Projectiles.Masomode.Environment
{
    public class FallenStarDay : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int num87 = Utils.SelectRandom(Main.rand, 16, 17, 17, 17);
                if (Main.tenthAnniversaryWorld)
                {
                    num87 = Utils.SelectRandom(Main.rand, 16, 16, 16, 17);
                }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.Hitbox.Intersects(Utils.CenteredRectangle(Main.screenPosition + vector58 / 2f, vector58 + new Vector2(400f))))
            {
                ...
                {
                    Gore.NewGore(Projectile.GetSource_Death(), Projectile.position, Main.rand.NextVector2CircularEdge(0.5f, 0.5f) * Projectile.velocity.Length(), Utils.SelectRandom(Main.rand, 16, 17, 17, 17, 17, 17, 17, 17));
                }
            }
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Vector2 origin10 = new Vector2(value22.Width / 2f, 10f);
            ...
            if (Main.tenthAnniversaryWorld)
            {
                color44 = Color.HotPink * 0.3f;
                color45 = Color.White * 0.75f;
                color45.A = 0;
                num190 = -0.1f;
            }
