    ...
    public class BoneSpear : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                {
                    Projectile.rotation = Projectile.rotation.AngleLerp(MathHelper.ToRadians(downAngle), 0.08f);
                }
                else
                {
                    Projectile.rotation = Projectile.rotation.AngleLerp(MathHelper.ToRadians(upAngle), 0.08f);
                }
