        ...
        public override bool PreAI()
        {
            ...
            else
            {
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(Terraria.Entity.InheritSource(Projectile), Projectile.Center, shootspeed.RotatedBy(rot), ModContent.ProjectileType<SpiritArrow>(), (int)(Projectile.damage * charge), 3f, Projectile.owner);
                }
                Projectile.Kill();
            }
            return false;
