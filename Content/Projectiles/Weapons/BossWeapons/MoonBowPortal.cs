    ...
    public class MoonBowPortal : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            if (Projectile.owner == Main.myPlayer && Main.player[Projectile.owner].active)
            {
                ...
                Projectile.NewProjectile(Terraria.Entity.InheritSource(Projectile), Projectile.Center, vel, ProjectileID.MoonlordArrowTrail, Projectile.damage, Projectile.knockBack, Projectile.owner);
            }
        }
