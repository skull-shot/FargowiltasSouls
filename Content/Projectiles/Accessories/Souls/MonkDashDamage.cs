...
namespace FargowiltasSouls.Content.Projectiles.Accessories.Souls
{
    public class MonkDashDamage : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            Projectile.NewProjectile(Projectile.GetSource_FromThis(), vector3, spinningpoint, ModContent.ProjectileType<MonkDashSlash>(), (int)(Projectile.damage * 0.5f), 0f, Main.myPlayer, num6);
    ...
    public class MonkDashSlash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] != 0f)
            {
                ...
                Projectile.velocity = Projectile.velocity.RotatedBy(Projectile.ai[0] / num3);
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int num152 = num149; num148 > 0 && num152 < num147 || num148 < 0 && num152 > num147; num152 += num148)
            {
                ...
                color32 *= num157 / (ProjectileID.Sets.TrailCacheLength[proj.type] * 1.5f);
                ...
                Main.EntitySpriteDraw(texture, position3, rect, color32, num158, origin, MathHelper.Lerp(proj.scale, value12, num152 / num150), effects2);
            }
