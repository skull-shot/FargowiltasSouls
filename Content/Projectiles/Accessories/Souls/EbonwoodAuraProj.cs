    ...
    public class EbonwoodAuraProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (!blackTile.IsLoaded || !diagonalNoise.IsLoaded)
                return false;
            var maxOpacity = Projectile.Opacity * (target.HasEffectEnchant<EbonwoodEffect>() ? 1f : 0.12f) * ModContent.GetInstance<FargoClientConfig>().TransparentFriendlyProjectiles;
