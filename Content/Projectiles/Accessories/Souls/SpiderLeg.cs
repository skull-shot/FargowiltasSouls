...
namespace FargowiltasSouls.Content.Projectiles.Accessories.Souls
{
    ...
    public class SpiderLeg
    {
        ...
        /// </summary>
        public Action<SpiderLeg, NPC> OnCompleteAnimation;
        ...
        public SpiderLeg(Vector2 defaultOffset, float legSizeFactor, float legLength1, float legLength2, int index)
        {
        ...
        public Vector2 LegCenter(Player owner) => owner.Center;// + owner.LegBraces[Index];
        public Vector2 DefaultPosition(Player owner) => LegCenter(owner) + DefaultOffset;
        ...
        public void SetAnimationEndAction(Action<SpiderLeg, NPC> action) => OnCompleteAnimation = action;
    }
    */
}
